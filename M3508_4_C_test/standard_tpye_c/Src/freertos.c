...
osThreadId cartest_task_handle;
/* USER CODE END PTD */
...
//    chassisTaskHandle = osThreadCreate(osThread(ChassisTask), NULL);
		...
		osThreadDef(Cartest_Task, cartest_task, osPriorityAboveNormal, 0, 512);
    cartest_task_handle = osThreadCreate(osThread(Cartest_Task), NULL);
